...
Previously, I have explored the applications of Machine Learning towards Astrophysics and Astronomy. My ability, lies not only in delivering cutting-edge and tangible research outcomes but to make those outcomes useful through the means of ML deployment.
...
I have been published at premier research venues such as [**NeurIPS**](https://nips.cc/) and [**MNRAS**](https://academic.oup.com/mnras). Check out my [CV](https://abhimanyu911.github.io/files/Abhimanyu_CV_aug25 (2).pdf) for a detailed list of my experiences and publications !
